...
categories: [实用工具]
tags: [网络]
description: iperf3是一款开源网络性能测试工具，可用于测量吞吐量、延迟和抖动等指标。本文介绍iperf3在Ubuntu、CentOS、Windows、macOS及Android系统下的安装方法，并详解常用命令参数，包括服务器/客户端模式、端口指定、测试时长、UDP测试、并发连接等。适合网络优化与带宽评估场景。
---
