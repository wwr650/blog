...
tags: [爬虫自动化]
description: 学校教务系统改用青果教务并接入学校统一认证后，旧的Python爬虫已无法适用新系统。本文记录一次单点登录的实操过程：通过抓包分析重定向与ticket传递机制，定位加密参数，解析前端AES加密逻辑并提取盐值，最终使用requests.session完成登录。不涉及原理，只记录步骤。
---
...
- ![1765614474473](/assets/img/2025-12-07-一次Python单点登陆实操/1765614474473.png)  
- ![1765614837123](/assets/img/2025-12-07-一次Python单点登陆实操/1765614837123.png)  
可见，进入教务系统`https:/jw.zzife.cn`，状态码302，重定向至`https:/jw.zzife.edu.cn/caslogin`，但是该URL，状态码200，并未直接重定向  
- ![1765615136032](/assets/img/2025-12-07-一次Python单点登陆实操/1765615136032.png)  
...
- ![1765615374922](/assets/img/2025-12-07-一次Python单点登陆实操/1765615374922.png)  
- ![1765615394932](/assets/img/2025-12-07-一次Python单点登陆实操/1765615394932.png)  
跳转至校统一认证平台，但是浏览器 get 两遍，对比两次请求，可见是为了补全 cookies  
- ![1765615863106](/assets/img/2025-12-07-一次Python单点登陆实操/1765615863106.png)  
- ![1765616014106](/assets/img/2025-12-07-一次Python单点登陆实操/1765616014106.png)  
当输入错误的用户名或密码，状态码401，页面回到统一认证平台；而输入正确用户名和密码，状态码302，重定向至教务系统，并且携带ticket  
- ![1765616232872](/assets/img/2025-12-07-一次Python单点登陆实操/1765616232872.png)  
...
打开控制台，调至源代码页  
- ![1765616713262](/assets/img/2025-12-07-一次Python单点登陆实操/1765616713262.png)  
可以找到密码的加密js文件，分析该文件可知，密码使用AES加密，该加密需要一个密钥，即源码内的`f`参数（也称盐值）  
- ![1765617089413](/assets/img/2025-12-07-一次Python单点登陆实操/1765617089413.png)  
- ![1765617155885](/assets/img/2025-12-07-一次Python单点登陆实操/1765617155885.png)  
